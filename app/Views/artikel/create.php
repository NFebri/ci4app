    ...
    <div class="col-8">
      ...
      <form action="/artikel/save" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control <?= ($validation->hasError('judul_artikel')) ? 'is-invalid' : ''; ?>" id="judul_artikel" name="judul_artikel" autofocus value="<?= old('judul_artikel'); ?>">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea class="form-control" name="isi_artikel" id="isi_artikel" value="<?= old('isi_artikel'); ?>" cols="30" rows="10"></textarea>
          </div>
        </div>
        <div class="form-group row">
          <label for="gambar_artikel" class="col-sm-2 col-form-label">Gambar Artikel</label>
          <div class="col-sm-2">
            <img src="/img/artikel/defaultartikel.jpg" class="img-thumbnail img-preview">
          </div>
          <div class="col-sm-8">
